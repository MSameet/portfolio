      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-2 my-14">
        <div className="order-1 md:order-[0]">
          ...
          <h1 className="text-[clamp(35px,5vw,120px)] font-bold font-spacegrotesk">
            Muhammad Sameet Ul Hassan
          </h1>
          <p className="text-secondary text-2xl">
            Architecting Seamless Digital Experiences with 3+ Years of Web
        ...
        <div className="flex md:justify-center ">
          <div className="relative ">
            ...
            <NextImage
              src="https://gist.github.com/user-attachments/assets/e6c1079f-f37e-42ac-84c8-aa019d92f0a2"
              width={250}
              height={500}
